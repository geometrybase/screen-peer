...
(function() {
  ...
  angular
  .module('screenPeer')
  .service('ScreenPeer',['_','Socket','EventEmitter','screenPeerUtil','DataConnection','$timeout','logging',fn]);

  function fn(_,Socket,EventEmitter,screenPeerUtil,DataConnection,$timeout,logging){
